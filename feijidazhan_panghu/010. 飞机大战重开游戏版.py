...
class EnemyPlane(pygame.sprite.Sprite):
    ...
    def __init__(self, screen):
        ...
        # 4.创建一个玩家飞机图片,当做真正的飞机
        self.image = pygame.image.load("../feijidazhan_res/enemy0.png")
...
class EnemyBullet(pygame.sprite.Sprite):
    def __init__(self, screen, x, y):
        ...
        # 创建图片
        self.image = pygame.image.load('../feijidazhan_res/bullet1.png')
    ...
    def __init__(self, screen, type):
        ...
        if type == "enemy":
            ...
            self.mImage = [pygame.image.load
                           ("../feijidazhan_res/enemy0_down" + str(v) + ".png") for v in range(1, 5)]
        else:
            self.mImage = [pygame.image.load
                           ("../feijidazhan_res/hero_blowup_n" + str(v) + ".png") for v in range(1, 5)]
