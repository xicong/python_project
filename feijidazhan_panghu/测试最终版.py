...
class HeroPlane(pygame.sprite.Sprite):
    ...
    def __init__(self, screen):
        ...
        # 图片
        self.image = pygame.image.load('../feijidazhan_res/hero1.png')
        # 根据图片image获取矩形的对象
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, x, y):
        pygame.sprite.Sprite.__init__(self)
        # 图片
        self.image = pygame.image.load('../feijidazhan_res/bullet.png')
        self.rect = self.image.get_rect()  # rect属性：矩形
...
class EnemyPlane(pygame.sprite.Sprite):
    ...
    def __init__(self, screen):
        pygame.sprite.Sprite.__init__(self)
        # 5.创建一个飞机的图片
        self.image = pygame.image.load('../feijidazhan_res/enemy0.png')  # 51*39
...
class EnemyBullet(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, x, y):
        ...
        # 坐标
        # 图片
        self.image = pygame.image.load('../feijidazhan_res/bullet1.png')  # 9*21
        self.rect = self.image.get_rect()  # rect属性：矩形
...
class GameSound(object):
    def __init__(self):
        ...
        pygame.mixer.music.load("../feijidazhan_res/bg2.ogg")
        pygame.mixer.music.set_volume(0.5)  # 声音大小 一半

        self.__bomb = pygame.mixer.Sound("../feijidazhan_res/bomb.wav")
...
class Bomb(object):
    ...
    def __init__(self, screen, type):
        ...
        if type == 'enemy':
            # 加载爆炸资源
            self.mImages = [
                pygame.image.load("../feijidazhan_res/enemy0_down" + str(v) + ".png") for v in range(1, 5)]
        else:
            # 加载爆炸资源
            self.mImages = [pygame.image.load(
                "../feijidazhan_res/hero_destroy" + str(v) + ".png") for v in range(1, 4)]
...
class GameBackground(object):
    # 初始化地图
    def __init__(self, screen):
        self.mImage1 = pygame.image.load("../feijidazhan_res/img_bg_level_1.jpg")
        self.mImage2 = pygame.image.load("../feijidazhan_res/img_bg_level_1.jpg")
        # 窗口
        self.screen = screen
        # 辅助移动地图
        self.y1 = 0
...
class Manager(object):
    ...
    def __init__(self):
        ...
        # 2创建一个背景图片
        # self.background = pygame.image.load('./feijidazhan_res/background.png')
    ...
    def drawText(self, text, x, y, textHeight=30, fontColor=(255, 255, 255), backgroudColor=None):
        ...
        font_obj = pygame.font.Font('../feijidazhan_res/baddf.ttf', textHeight)
